...
const TeamPanel: React.FC<TeamPanelProps> = ({ title, teams, side, expanded }) => {
  ...
  return (
    <div  id="events" className={`
      flex flex-col justify-start py-8 transition-all duration-[2000ms] ease-in-out
...
export default function EventsSection() {
  ...
  useEffect(() => {
    // Start animation 500ms after load
    ...
    >
      <div className="max-w-7xl w-full mx-auto">
        ...
        <div className="text-center mt-14 pt-12 border-t-4 border-red-500">
          ...
          <button className="mt-8 px-12 py-5 text-2xl font-black uppercase tracking-widest rounded-full transition-all duration-700 ease-in-out hover:scale-105 bg-red-500 text-white border-4 border-black shadow-[5px_5px_0_#000]">
            APPLY TODAY
          </button>
        </div>
      </div>
